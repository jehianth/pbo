...
public class login extends javax.swing.JFrame {
    ...
    public login() {
        initComponents();
        koneksi_void login = new koneksi_void();
        login.db();
        con = login.con;
        stm = login.stm;
    }
    ...
    private void bloginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bloginActionPerformed
        ...
        try{
            rs = stm.executeQuery("select * from admin where username='" + tusername.getText() + "' and password='" + tpassword.getText() + "'");
            if (rs.next()) {
                JOptionPane.showMessageDialog(null, "Selamat datang " + tusername.getText() + "!");
                new data().show();
                dispose();
            } else {
